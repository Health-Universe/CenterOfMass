...
st.markdown("## Center of Mass - Ligand")
st.divider()
...
pdb_file = st.file_uploader(
    "Upload",
    type="pdb",
    help="**Input:** Protein PDB \n\n**Output:** Center of Mass of Ligand"
)

# File Processing
if pdb_file is not None:
    run_button = st.button("Run", help="Calculating Center of Mass of Ligand")
    if run_button:
        with st.spinner("Running..."):
            ...
            st.divider()
            st.subheader("Output")
            st.write("Center of Mass for the ligand is the following:")
